...
module MyLayoutGenerator
  ...
  n_local = Trans.new(2, false, (-2.8955/dbu).to_i, (-16.0/dbu).to_i)
  p_local = Trans.new(2, false, (-2.8955/dbu).to_i, (-5.0/dbu).to_i)
  ...
  base_y = -107.4987 / dbu
  fp_trans = Trans.new(0.0, false, base_x.to_i, base_y.to_i)
  n_local = Trans.new(0, true,  (2.8955/dbu).to_i, (-16.0/dbu).to_i)
  p_local = Trans.new(0, true,  (2.8955/dbu).to_i, (-5.0/dbu).to_i)
  top_cell.insert(CellInstArray.new(nch_pcell_id, fp_trans * n_local))
  top_cell.insert(CellInstArray.new(pch_pcell_id, fp_trans * p_local))
  ...
  base_y = -90.151 / dbu
  fp_trans = Trans.new(0.0, false, base_x.to_i, base_y.to_i)
  n_local = Trans.new(0, false, (2.8955/dbu).to_i, (-4.0/dbu).to_i)
  p_local = Trans.new(0, false, (2.8955/dbu).to_i, (-15.0/dbu).to_i)
  top_cell.insert(CellInstArray.new(nch_pcell_id, fp_trans * n_local))
  top_cell.insert(CellInstArray.new(pch_pcell_id, fp_trans * p_local))
